...
class ChavConfig:
    ...
    duplicate_ingestion: dict = field(
        default_factory=lambda: {
            "duplicate_ratio_threshold": 0.05,
            "warn_ratio_threshold": 0.01,
        }
    )
    category_explosion: dict = field(
        default_factory=lambda: {
    ...
    structural_missingness: dict = field(
        default_factory=lambda: {
